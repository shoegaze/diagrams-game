...
diagrams.ui.cell.flip_elem = (function diagrams$ui$cell$flip_elem(mat,x,y){
return diagrams.matrix.update_elem.call(null,mat,x,y,cljs.core.not);
});
...
cljs.core.swap_BANG_.call(null,walls,diagrams.ui.cell.flip_elem,x,y);
...
cljs.core.swap_BANG_.call(null,markers,diagrams.ui.cell.flip_elem,x,y);
} else {
}
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11889__$1)].join('')));

}
} else {
var G__11890 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [wall_QMARK_,marker_QMARK_], null);
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__11890)){
return "image/empty__60_60.png";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__11890)){
return "image/marker__60_60.png";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__11890)){
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.cell","span.cell",-564624425),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (p1__11892_SHARP_){
return diagrams.ui.cell.on_left_click.call(null,p1__11892_SHARP_,game,walls,markers,x,y);
}),new cljs.core.Keyword(null,"on-context-menu","on-context-menu",-1330744340),(function (p1__11893_SHARP_){
return diagrams.ui.cell.on_right_click.call(null,p1__11893_SHARP_,game,walls,markers,x,y);
