...
var G__5860 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__5860,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__5862__i < G__5862__a.length) {G__5862__a[G__5862__i] = arguments[G__5862__i + 0]; ++G__5862__i;}
  args = new cljs.core.IndexedSeq(G__5862__a,0,null);
} 
...
var G__5864 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__5864,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__5865__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__5865 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5866__i = 0, G__5866__a = new Array(arguments.length -  0);
while (G__5866__i < G__5866__a.length) {G__5866__a[G__5866__i] = arguments[G__5866__i + 0]; ++G__5866__i;}
  args = new cljs.core.IndexedSeq(G__5866__a,0,null);
} 
return G__5865__delegate.call(this,args);};
G__5865.cljs$lang$maxFixedArity = 0;
G__5865.cljs$lang$applyTo = (function (arglist__5867){
...
var G__5868 = props;
var G__5868__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__5868,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__5868);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__5868__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__5869 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__5869,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__5869;
}
})(),id_class);
...
var G__5870 = (cljs.core.count.call(null,argv) - first_child);
switch (G__5870) {
case (0):
...
var vec__5872 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__5872,(0),null);
var id = cljs.core.nth.call(null,vec__5872,(1),null);
var className = cljs.core.nth.call(null,vec__5872,(2),null);
...
var temp__5808__auto___5875 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___5875 == null)){
} else {
var key_5876 = temp__5808__auto___5875;
(jsprops.key = key_5876);
}
...
var temp__5808__auto___5877 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___5877 == null)){
} else {
var key_5878 = temp__5808__auto___5877;
(jsprops.key = key_5878);
}
...
var temp__5808__auto___5879 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___5879 == null)){
} else {
var key_5880 = temp__5808__auto___5879;
...
var temp__5808__auto___5881 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___5881 == null)){
} else {
var key_5882 = temp__5808__auto___5881;
(jsprops.key = key_5882);
}
...
var temp__5808__auto___5883 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___5883 == null)){
} else {
var key_5884 = temp__5808__auto___5883;
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__5885_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__5885_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__5886 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__5886,(0),null);
var derefed = cljs.core.nth.call(null,vec__5886,(1),null);
...
break;
default:
var G__5891 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__5892 = compiler;
v = G__5891;
compiler = G__5892;
continue;
...
var G__5893 = tag;
var G__5893__$1 = (((G__5893 instanceof cljs.core.Keyword))?G__5893.fqn:null);
switch (G__5893__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template5896 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template5896 = (function (opts,id,fn_to_element,parse_fn,meta5897){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template5896.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_5898,meta5897__$1){
var self__ = this;
var _5898__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template5896(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta5897__$1));
}));

(reagent.impl.template.t_reagent$impl$template5896.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_5898){
var self__ = this;
var _5898__$1 = this;
return self__.meta5897;
}));

(reagent.impl.template.t_reagent$impl$template5896.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template5896.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template5896.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template5896.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template5896.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template5896.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta5897","meta5897",-305145324,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template5896.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template5896.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template5896");

(reagent.impl.template.t_reagent$impl$template5896.cljs$lang$ctorPrWriter = (function (this__5329__auto__,writer__5330__auto__,opt__5331__auto__){
return cljs.core._write.call(null,writer__5330__auto__,"reagent.impl.template/t_reagent$impl$template5896");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template5896.
 */
reagent.impl.template.__GT_t_reagent$impl$template5896 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template5896(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5897){
return (new reagent.impl.template.t_reagent$impl$template5896(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5897));
});

}

return (new reagent.impl.template.t_reagent$impl$template5896(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
